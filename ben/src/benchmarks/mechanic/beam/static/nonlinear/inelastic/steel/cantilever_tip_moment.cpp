...
void tests::beam::static_nonlinear::inelastic::steel::cantilever_tip_moment(void) 
{
	/*
	...
	//model
	fea::models::Model model("cantilever tip moment", "benchmarks/beam/static/nonlinear/inelastic/steel");
	...
	((fea::mesh::sections::Rectangle*) model.mesh()->section(0))->mesh_w(2);
	...
	//loads
	model.boundary()->add_load_case(1, fea::mesh::nodes::dof::rotation_z, 62.5e3);

	//solver
	fea::mesh::elements::Beam2::mixed(false);
	fea::mesh::elements::Beam2::shear(true);
