...
void tests::materials::uniaxial::concrete_tension(void) 
{
	//model
	fea::models::Model model("Concrete uniaxial tension");
	...
	//loads
	model.boundary()->add_load_case(1, fea::mesh::nodes::dof::translation_x, 3.25e4);
